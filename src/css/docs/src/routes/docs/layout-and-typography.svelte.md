...
<div class="alert alert-info max-w-3xl text-sm not-prose">
  <div>
    ...
    <p><Translate text="Make sure you require <span class='badge badge-outline'>dculusui</span> AFTER <span class='badge badge-outline'>@tailwindcss/typography</span> in tailwind.config.js" /></p>
  </div>
</div>
...
module.exports = {
  //...
  plugins: [require("@tailwindcss/typography"), require("dculusui")],
}
```
