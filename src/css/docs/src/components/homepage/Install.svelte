...
<div class="hero bg-base-100 text-base-content mx-auto min-h-screen max-w-md md:max-w-full">
  <div class="hero-content text-center">
    <div class="w-full max-w-md">
      ...
      <div class="mx-auto my-2 w-full max-w-md">
        <div class="mockup-code mx-auto w-full max-w-xs text-left shadow-lg sm:max-w-none"><pre data-prefix="$"><code>npm i dculusui</code></pre></div>
  ...
  module.exports = {`{`}
    plugins: [
      <span class="badge badge-secondary">require('dculusui'),</span>
    ],
  {`}`}</code></pre>
          </div>
        </div>
